...
const stats = [
  { label: "Tasks Completed", value: "24", change: "+3 this week", icon: CheckCircle, color: "text-emerald-600", bg: "bg-emerald-50" },
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
                  ...
                  <Link href="/browse" className="text-xs text-emerald-600 font-semibold hover:underline">
                    + Add
                  </Link>
                </div>
                    ...
                    <div key={h.name} className="px-5 py-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-gray-500 mt-0.5">{h.role}</div>
                      ...
                      <div key={i} className="px-5 py-3.5 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-400">{t.helper} · {t.date}</div>
                          </div>
                        </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="grid grid-cols-7 divide-x divide-gray-50">
                  {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, i) => (
                    <div key={day} className={`px-2 py-3 text-center ${i === 0 ? "bg-emerald-50" : ""}`}>
                      <div className="text-xs text-gray-400 mb-1">{day}</div>
                      <div className={`text-sm font-bold ${i === 0 ? "text-emerald-600" : "text-gray-700"}`}>
                        {3 + i}
                      </div>
                      {i < 5 && (
                        <div className="mt-2">
